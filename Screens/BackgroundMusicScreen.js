...
export default class BackgroundMusicScreen extends React.Component{
    constructor(){
        super();
        this.state={
    ...
    render(){
        return(
            <View>
                ...
                <Text onPress={()=>{this.props.navigation.navigate('HomeRoute')}}  style={{fontSize:40}}>Navigate to main app</Text>
            </View>
        )
    }
}